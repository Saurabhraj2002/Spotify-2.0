        ...
        >
          ...
          <div className="nav-btn">
            ...
            <Modal show={show} onHide={handleClose}>
              ...
              <Modal.Body>
                <p>
                  email: <strong>raj@example.com</strong>{" "}
                </p>
                <p>
                  pwd: <strong>raj123</strong>
                </p>
                <Form>
            ...
            <br />
            <a href="https://github.com/Saurabhraj2002" target="_blank">
              <span className="copyleft"></span> Saurabh Raj
            </a>
          </div>
        </nav>
      </div>
